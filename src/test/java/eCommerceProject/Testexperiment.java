...
//                }
                ...
                String mobile_MainSonyXperia1 = driver.findElement(By.xpath("(//a[1]")).getText();
            ...
            try {
                ...
                System.out.println("Pass: the heading in Popup window is asme as main window: COMPARE PRODUCTS");
            } catch (Exception e) {
                e.printStackTrace();
            }
